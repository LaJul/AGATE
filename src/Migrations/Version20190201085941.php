 ...
 */
final class Version20190201085941 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE player_round (player_id INT NOT NULL, round_id INT NOT NULL, INDEX IDX_7A9C917299E6F5DF (player_id), INDEX IDX_7A9C9172A6005CA0 (round_id), PRIMARY KEY(player_id, round_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
