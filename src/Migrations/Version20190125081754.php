 ...
 */
final class Version20190125081754 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliate ADD firstName VARCHAR(255) NOT NULL, CHANGE title title VARCHAR(3) DEFAULT NULL, CHANGE name lastName VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliate ADD name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP lastName, DROP firstName, CHANGE title title VARCHAR(3) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
