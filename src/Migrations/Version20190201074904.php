 ...
 */
final class Version20190201074904 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE round_tournamentOutPlayers (round_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_29E8FAAA6005CA0 (round_id), INDEX IDX_29E8FAA99E6F5DF (player_id), PRIMARY KEY(round_id, player_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE round_roundOutPlayers (round_id INT NOT NULL, player_id INT NOT NULL, INDEX IDX_5B4C3285A6005CA0 (round_id), INDEX IDX_5B4C328599E6F5DF (player_id), PRIMARY KEY(round_id, player_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE round_tournamentOutPlayers ADD CONSTRAINT FK_29E8FAAA6005CA0 FOREIGN KEY (round_id) REFERENCES round (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE round_tournamentOutPlayers ADD CONSTRAINT FK_29E8FAA99E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE round_roundOutPlayers ADD CONSTRAINT FK_5B4C3285A6005CA0 FOREIGN KEY (round_id) REFERENCES round (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE round_roundOutPlayers ADD CONSTRAINT FK_5B4C328599E6F5DF FOREIGN KEY (player_id) REFERENCES player (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE round_tournamentOutPlayers');
        $this->addSql('DROP TABLE round_roundOutPlayers');
