 ...
 */
final class Version20190201101130 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliate CHANGE title title VARCHAR(3) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE rapid rapid INT NOT NULL, CHANGE blitz blitz INT NOT NULL');
